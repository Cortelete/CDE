...
// Contém os dados exclusivamente para o deck do "Guia PMBOK".
    ...
    cards: [
        ...
        },
        {
            ...
            topicsDetails: [
                ...
                { title: "Gerenciar Qualidade", content: "O processo de traduzir o plano de gerenciamento da qualidade em atividades de qualidade executáveis que incorporam as políticas de qualidade da organização no projeto." },
                { title: "Controlar Qualidade", content: "O processo de monitorar e registrar os resultados da execução das atividades de gerenciamento da qualidade para avaliar o desempenho e garantir que as saídas do projeto estejam completas, corretas e atendam às expectativas do cliente." }
            ],
        ...
        },
        {
            ...
            topicsDetails: [
                { title: "Planejar Comunicações", content: "Desenvolver uma abordagem e um plano apropriados para as atividades de comunicação do projeto com base nas necessidades de informação de cada parte interessada." },
                { title: "Gerenciar Comunicações", content: "O processo de garantir a coleta, criação, distribuição e disposição oportuna e apropriada das informações do projeto." },
        ...
        },
        {
            ...
            topicsDetails: [
                { title: "Riscos Positivos e Negativos", content: "Riscos não são apenas ameaças (negativos), mas também oportunidades (positivos) que devem ser gerenciadas para maximizar seus benefícios." },
